...
function restore_base
{
    ...
    then
        ...
        docker exec -i superlogica-mysql mysql -uroot -proot -D $LICENCA_LOCAL_NAME -e "UPDATE APP SET ST_URL_APP = REPLACE(ST_URL_APP, 'https://pilotosign.superlogica.net/', 'http://localhost/');"
